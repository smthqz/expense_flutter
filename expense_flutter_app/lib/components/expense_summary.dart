import 'package:expense_flutter_app/bar_graph/bar_graph.dart';
...
class ExpenseSummary extends StatelessWidget {
  ...
  double calculateMax(
    ...
    values.sort();
    // get largets amount (which is at the end of the sorted list)
              ...
              children: [
                ...
                Text('$currencySymbol' +
                    calculateWeekTotal(value, sunday, monday, tuesday,
                        wednesday, thursday, friday, saturday), style: TextStyle(color: Colors.black))
              ],
            ),
          ),
